...
| Nombre | Características | Código abierto | Sistemas operativos |
| --- | --- | --- | --- |
| [`EN`] [FileMasta](https://ohhsodead.github.io/FileMasta/) `General` | Búsqueda de enlaces directos gracias a [od-database](https://github.com/simon987/od-database): Video, Música, Libros, Software, Videojuegos, Subtítulos, entre otros. | `Sí`, disponible en [Github](https://github.com/ohhsodead/FileMasta) | Windows |
