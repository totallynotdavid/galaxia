---
title: Piratería
description: 'Recursos de la escena, foros, NZB indexers y sitios para encontrar y verificar contenido: prereleases, torrents, newsgroups.'
---

# Piratería

Recursos para la búsqueda y verificación de contenido digital: trackers
de la escena, foros de descargas, redes entre pares (P2P) y Usenet.
...
| Foro | Descripción |
| --- | --- |
| [Nulled](https://www.nulled.to/) | Foro general sobre seguridad informática y hacking. |
